...
class Student implements Serializable {
    ...
    public Student(String name, int rollNumber, int age, String CGPA, String course) {
        this.name = name;
    ...
    public String toString() {
        return "Name of student: " + name + ", Roll Number: " + rollNumber + ", Age: " + age + ", CGPA: " +CGPA + ", Course: " + course;
    }
}
...
public class StudentManagementSystemApp {
   ...
   static StudentManagementSystem sys = new StudentManagementSystem();
    ...
    private static void removeStudent() {
        ...
        int rollNumber = validateIntInput();
        if (sys.removeStudent(rollNumber)) {
    ...
    private static void editStudentDetails() {
        ...
        int rollNumber = validateIntInput();
        Student student = sys.searchStudent(rollNumber);
        if (student != null) {
            ...
            String course = validateStringInput();
            sys.editStudentDetails(rollNumber, name, age, grade, course);
    ...
    private static void displayAllStudents() {
        List<Student> students = sys.getAllStudents();
        if (students.isEmpty()) {
